...
ddev config --project-type=php --disable-settings-management --docroot=shopware/public \
        ...
        --database=mysql:8.0 --php-version=8.3 --nodejs-version=22 --webserver-type=apache-fpm \
        --web-environment-add="APP_ENV=dev"
...
ddev exec APP_ENV=prod bin/console framework:demodata